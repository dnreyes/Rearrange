...
public delegate void TouchZonePointerUpDelegate(Vector2 worldPosition);
...
public class TouchZone : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
	...
	public TouchZonePointerUpDelegate OnTouchZonePointerUp;
...
private Image m_Image;
	...
	public void OnPointerUp(PointerEventData data)
	{
		...
		OnTouchZonePointerUp(Camera.main.ScreenToWorldPoint(new Vector2(windSourcePositionRaw.x, windSourcePositionRaw.y)));
	}
