...
public delegate void WindPadPointerUpDelegate(Vector2 worldPosition);

[RequireComponent(typeof(Image))]
public class WindPad : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
	...
	public WindPadPointerUpDelegate OnWindPadPointerUp;
...
private Image m_Image;
	...
	public void OnPointerUp(PointerEventData data)
	{
		...
		Vector3 windSourcePositionRaw = data.position;

		OnWindPadPointerUp(Camera.main.ScreenToWorldPoint(new Vector2(windSourcePositionRaw.x, windSourcePositionRaw.y)));
	}
